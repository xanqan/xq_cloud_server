...
(
    ...
    size_max    bigint unsigned  default 0                 not null comment '储存空间大小（GB） 0-不限制',
...
INSERT INTO user (name, password) VALUES ('demo0', '$2a$10$KrCaa8a0Hcig8kRWXYHakubmIjQCaE7SKU.Qwd/7gMnjiXWC1DT0i');
